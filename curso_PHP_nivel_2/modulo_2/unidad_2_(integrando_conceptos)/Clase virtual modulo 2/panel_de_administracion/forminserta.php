          ...
          <div class="widget widget-nopad">
            ...
            <div class="widget-content">
              <div class="widget big-stats-container">
                <div class="widget-content">
<br>
<form id="form" name="form" method="post" action="insertacoches.php" class="form-horizontal">
  <div class="control-group">
    ...
    <div class="controls">
    <input name="color" type="text" id="color" size="48" />
    </div>
    </div>
  ...
  <div class="controls">
    ...
    <label class="radio">
      <input name="combustible" type="radio" value="nafta" id="optionsRadios2" checked/> Nafta 
    </label>
  </div>
  </div>
