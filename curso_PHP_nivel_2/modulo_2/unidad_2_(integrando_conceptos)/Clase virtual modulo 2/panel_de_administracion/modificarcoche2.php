        ...
        <div class="span12">
          <div class="widget widget-nopad">
            <div class="widget-header"> <i class="icon-list-alt"></i>
              <h3> Datos del vehiculo modificado</h3>
            </div>
            <!-- /widget-header -->
...
$result = mysqli_query($conexion, "UPDATE ocasion SET idmarca=$idmarca, modelo='$modelo', combustible='$combustible', color='$color', fecha='$fecha', precio='$precio' WHERE id='$id'") or die (mysqli_error($conexion));

echo "Ha actualizado los siguientes datos:";
echo "<br><br>";
