		...
		<div id="services">
		  <h2>Ingreso de usuarios </h2>
			<div id="servicescontent">
			  <p>Para ingresar, complete el siguiente formulario:</p>
<p class="titulos"><?php echo @$_GET['mensaje']; ?></p>
<form id="form1" name="form1" method="post" action="validacion.php">
  <table width="60%">
    <tr>
      <td width="16%">Usuario</td>
      <td width="84%"><label>
        <input name="usuario" type="text" id="usuario" size="50" />
        </label></td>
    </tr>
    <tr>
...
<p>&nbsp;</p>
<p>Para acceder al contenido para usuarios, hace clic <a href="contenido_usuario.php">aqu&iacute;</a></p>
<p>Si no est&aacute;s registrado, hac&eacute; clic <a href="registro.php">aqu&iacute;</a></p>
<p>&nbsp;</p>
		  </div>
